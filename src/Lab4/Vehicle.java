...
public class Vehicle {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                "after assign object reference minivan to v, v reference the same memory block as minivan reference to");
        ...
        System.out.println(
                "sedan.passengers=" + sedan.passengers + "sedan.mpg=" + sedan.mpg + " sedan.fuelcap=" + sedan.fuelcap);
        ...
        System.out.println(
                "sedan references to the same object (memory block), however thevalue of variable, mpg, in that object changes");
        System.out.println(
                "sedan.passenger=" + sedan.passengers + "sedan.mpg=" + sedan.mpg + " sedan.fuelcap=" + sedan.fuelcap);
    }
}